        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light ">
                ...
                <div class="collapse navbar-collapse justify-content-md-end" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Lista de Imóveis</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <?php
                            ...
                            $sql = "SELECT * FROM imovel ORDER BY cod_imovel DESC";
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <b>Forma de Contrato: </b> <?php echo $linha['forma_contrato'];?><br><hr>
                                        <b>Área: </b> <?php echo $linha['area'];?>m2<br><hr>
                                        <b>Quantidade de Cômodos: </b> <?php echo $linha['qnt_comodos'];?><br><hr>
