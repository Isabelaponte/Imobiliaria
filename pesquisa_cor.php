    ...
    <div class="container">
        ...
        <h4 class="page-header">LISTA DE IMÓVEIS</h4>
                <form class="form-inline" action="pesquisa_cor.php" method="POST">
                    <input type="text" class="form-control form-control-sm col-md-10 col-sm-10" name="c_pesquisa" placeholder="Pesquisar Corretor" required="">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <?php
                            ...
                            $sql="SELECT * FROM corretor WHERE nome like '%".$search."%'";
